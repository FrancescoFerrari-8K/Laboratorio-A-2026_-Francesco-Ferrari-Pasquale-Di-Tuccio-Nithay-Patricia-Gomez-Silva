...
public class Cliente extends Guest {
  ...
  /*
   * /
   * questo metodo serve per visualizzare le propie prenotazioni, siano quelle
   * vechie che quelle nuove. ogni prenotazione ti mostra sia il nome, cognome,
   * 
   */
  ...
  /*
   * /
   * questo metodo serve per creare le prenotazione dal cliente mostrando tutta la
   * informazione compreso il prezzo totale
              ...
              case 2:
                ...
                do {
                  ...
                  switch (sceltaDiModifica) {
                    case 1:
                      this.chiediQuantiPostiPrenotareEmodifica(null, prenotazioneSelezionata); // questo metodo serve
                                                                                               // per modificare i
                                                                                               // numero di posti da una
                                                                                               // proiezione
                      break;
  ...
  /*
   * /
   * metodo privato che serve a chiedere quanti posti prenotare per modificare la prenotazione
   */
  ...
  /*/
   * questo metodo serve per leggere un numero intero usando il nextLine invece del nextInt (che ogni tanto
   * da problemi alla lettura
   */
